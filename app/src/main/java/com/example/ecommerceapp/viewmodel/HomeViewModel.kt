...
import com.example.ecommerceapp.data.Image
import com.example.ecommerceapp.data.ImageDatabase
import com.example.ecommerceapp.data.ProductDatabase
import com.example.ecommerceapp.model.BaseClass
import com.example.ecommerceapp.model.Product
import com.example.ecommerceapp.service.ProductsAPI
import com.example.ecommerceapp.utils.CustomSharedPreferences
...
class HomeViewModel : ViewModel() {
    ...
    fun storeInSQLite(context: Context, products: ArrayList<Product>) {
        ...
        viewModelScope.launch {
            ...
            products.forEach {
                val aProduct = com.example.ecommerceapp.data.Product(it.id,it.title,it.description,it.price,it.discountPercentage,it.rating,it.stock,it.brand,it.category,
                it.thumbnail)
